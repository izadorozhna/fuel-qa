...
LDAP_PLUGIN_PATH = os.environ.get('LDAP_PLUGIN_PATH')
...
LDAP_QUERY_SCOPE = os.environ.get('LDAP_QUERY_SCOPE')
LDAP_USERS_TREE_DN = os.environ.get('LDAP_USERS_TREE_DN')
LDAP_GROUPS_TREE_DN = os.environ.get('LDAP_GROUPS_TREE_DN')
LDAP_USER_OBJECT_CLASS = os.environ.get('LDAP_USER_OBJECT_CLASS')
LDAP_USER_NAME_ATTRIBUTE = os.environ.get('LDAP_USER_NAME_ATTRIBUTE')
