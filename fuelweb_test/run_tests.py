...
def import_tests():
    ...
    from tests import test_package_tempest  # tempest
    from tests import test_package_rally  # rally
    from tests import test_package_selenium  # selenium
    ...
    from tests.plugins.plugin_ldap import test_plugin_ldap # noqa
    ...
    from tests.plugins.plugin_zabbix_and_lbaas import test_plugin_zabbix_and_lbaas_tempest # noqa
